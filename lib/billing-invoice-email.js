...
export async function maybeEmailBillingInvoice(db, facturaId, { transporter } = {}) {
  ...
  const supportEmail = String(paymentMetadata.support_email || (brand === "e-Marqet" ? process.env.EMARQET_SUPPORT_EMAIL : "") || process.env.MAIL_FROM || "contact@trevoro.ro").trim();
