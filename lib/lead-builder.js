...
function messageDrafts(candidate = {}, lead = {}, insight = {}) {
  ...
  const stock = Number(candidate.estimated_items_count || 0);
  const stockText = stock ? ` Am vazut indicii publice ca aveti aproximativ ${stock} autoturisme/anunturi publice.` : "";
  const websiteText = candidate.website ? ` Am vazut website-ul ${candidate.website}.` : "";
  const subject = `Invitatie Partener Fondator E-MARQET - ${name}`;
  const shortEmail = [
    "Buna ziua,",
    "",
    `Am identificat ${name} in ${city} si dorim sa va invitam in programul Partener Fondator E-MARQET pentru parcuri auto si auto rulate.${stockText}${websiteText}`,
    "",
    "In perioada de lansare putem pregati importul gratuit al stocului auto si publicarea gratuita in platforma, fara introducere manuala a anunturilor si fara comision la vanzare.",
    "",
    "Partenerii fondatori primesc suport la configurare, badge dedicat si promovare initiala pe e-Marqet si pe social media.",
    "",
    "Putem discuta cateva minute despre varianta potrivita pentru stocul dumneavoastra?",
    "",
    "Cu respect,",
    "Echipa E-MARQET"
  ].join("\n");
  const detailedEmail = [
    shortEmail,
    "",
    "Putem prelua stocul din website, feed XML, CSV, JSON, API sau import manual asistat. Pentru parcurile auto partenere prioritizam configurarea importului si promovarea initiala.",
    "",
  ...
  return [
    ...
    { message_type: "whatsapp", channel: "whatsapp", subject: "", body: `Buna ziua, am identificat ${name} si vrem sa va invitam ca Partener Fondator E-MARQET pentru parcuri auto si auto rulate. Importul stocului si publicarea sunt gratuite in lansare, fara comision la vanzare.` },
    { message_type: "facebook", channel: "facebook", subject: "", body: `Buna ziua! E-MARQET pregateste zona de parcuri auto si auto rulate. ${name} poate intra in programul Partener Fondator, cu import gratuit de stoc, publicare gratuita si promovare initiala.` },
    { message_type: "messenger", channel: "messenger", subject: "", body: `Buna ziua! E-MARQET pregateste zona de parcuri auto si auto rulate. ${name} poate intra in programul Partener Fondator, cu import gratuit de stoc si promovare initiala.` },
    { message_type: "call_script", channel: "phone", subject: "Scenariu apel", body: `Salutati, confirmati ca discutati cu ${name}, apoi propuneti: import gratuit stoc auto, publicare gratuita la lansare, fara comision, badge Partener Fondator si sincronizare din website/feed/CSV/API. Nu mentionati un numar de masini daca nu este confirmat public.` },
    { message_type: "followup_3_days", channel: "email", subject: `Revenire E-MARQET - ${name}`, body: "Buna ziua,\n\nRevin cu invitatia pentru programul Partener Fondator E-MARQET pentru parcuri auto si auto rulate. Putem pregati importul gratuit al stocului fara introducere manuala, publicare gratuita in lansare si fara comision la vanzare.\n\nCu respect,\nEchipa E-MARQET" },
    { message_type: "followup_7_days", channel: "email", subject: `Ultima revenire - Partener Fondator E-MARQET`, body: "Buna ziua,\n\nMai las aici invitatia pentru listarea ca Partener Fondator E-MARQET: import gratuit, publicare gratuita si suport la configurare. Daca nu este momentul potrivit, nu va mai deranjam.\n\nCu respect,\nEchipa E-MARQET" },
    { message_type: "followup_30_days", channel: "email", subject: `Follow-up lansare E-MARQET - ${name}`, body: "Buna ziua,\n\nRevenim dupa perioada initiala de lansare. Daca doriti sa testati e-Marqet cu import gratuit de stoc si badge Partener Fondator, putem programa configurarea.\n\nCu respect,\nEchipa E-MARQET" }
  ];
}
