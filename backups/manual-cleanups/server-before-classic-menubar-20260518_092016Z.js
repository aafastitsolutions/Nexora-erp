...
function crmShellStart(active, title, subtitle="", userEmail="", userModules=[], companyStatus="", companyName=""){
  ...
  const navigation = buildWorkspaceNavigation(active, userModules, userEmail);
  ...
  return `
  ${uiShellStyles()}
  <body class="crm-body" data-shell="${escapeHtml(String(active || ""))}" data-left-sidebar="${navigation.hasLeftSidebar ? "visible" : "hidden"}" data-right-sidebar="${navigation.hasRightSidebar ? "visible" : "hidden"}" data-favorite-modules="${escapeHtml(JSON.stringify(navigation.favoriteModules))}">
    <div class="crm-layout">
      ${navigation.hasLeftSidebar ? `
      <aside class="crm-sidebar crm-sidebar-left">
        <div class="crm-brand">
      ...
      ` : ""}
      ${navigation.hasRightSidebar ? `
      <aside class="crm-sidebar crm-sidebar-right">
        <div class="crm-brand">
          <div class="crm-brand-badge">E</div>
          <div class="crm-brand-copy">
            <div class="crm-brand-title">ERP Workspace</div>
            <div class="crm-brand-sub">Operațiuni interne și favorite salvate</div>
          </div>
        </div>
        ${navigation.rightSidebarHtml}
        <div class="crm-sidebar-footer">
          <div class="crm-sidebar-footer-title">Temă</div>
          ${crmThemeSelect()}
        </div>
